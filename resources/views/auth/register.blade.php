            ...
            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                <div class="card card-signup">
                    <form class="form" method="POST" action="{{ route('register') }}">
                        ...
                        <p class="text-divider">Completa los datos</p>
                        <div class="content">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Nombre..." value="{{ old('name') }}" required autofocus>
                            </div>
    ...
    <footer class="footer">
        <div class="container">
            <nav class="pull-left">
                <ul>
                    <li>
                        <a href="http://www.consyssion.com">
                            Consyssion
                        </a>
                    </li>
                    <li>
            ...
            <div class="copyright pull-right">
                &copy; 2017, made with <i class="fa fa-heart heart"></i> by <a href="http://www.consyssion.com" target="_blank">Consyssion</a>
            </div>
        </div>
    </footer>
